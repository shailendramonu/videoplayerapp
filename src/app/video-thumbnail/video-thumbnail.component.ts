...
import { COMPONENT_WITH_ON_HOVER } from '../directives/on-hover.directive';
import { VideoPlayerConfig } from '../models/thunmbnail-video.models';
import { BehaviorSubject, Subject } from 'rxjs';
import { filter, switchMap, take, takeUntil } from 'rxjs/operators';
import { preloadVideoThumbs } from '../utils/preload-thumb.util';
...
@Component({
  ...
  providers: [
     { provide: COMPONENT_WITH_ON_HOVER, useExisting: VideoThumbnailComponent }
  ]
})
export class VideoThumbnailComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
